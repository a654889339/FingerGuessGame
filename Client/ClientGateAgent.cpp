...
ClientGateAgent::ClientGateAgent()
{
    m_nNextPingTime = 0;
    ...
    REGISTER_EXTERNAL_FUNC(s2c_ping_respond, &ClientGateAgent::OnS2CPingRespond, sizeof(S2C_PING_RESPOND));
    REGISTER_EXTERNAL_FUNC(s2c_login_respond, &ClientGateAgent::OnS2CLoginRespond, sizeof(S2C_LOGIN_RESPOND));
}
...
void ClientGateAgent::UnInit()
{
    Quit();
}

void ClientGateAgent::Active()
{
    ProcessNetwork();
}

void ClientGateAgent::DisConnect()
{
    if (IsEnable())
    {
        DoC2SQuitNotify();
...
bool ClientGateAgent::DoC2SPingRequest()
{
    bool bResult = false;
    bool bRetCode = false;
...
bool ClientGateAgent::DoC2SQuitNotify()
{
    bool bResult = false;
    bool bRetCode = false;
...
bool ClientGateAgent::DoC2SLoginRequest()
{
    bool bResult = false;
    bool bRetCode = false;
...
// Private
void ClientGateAgent::OnS2CPingRespond(BYTE* pbyData, size_t uSize)
{
}

void ClientGateAgent::OnS2CLoginRespond(BYTE* pbyData, size_t uSize)
{
...
void ClientGateAgent::ProcessPackage(BYTE* pbyData, size_t uDataLen)
{
...
void ClientGateAgent::ConnectionLost()
{
